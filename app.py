...
# =========================================================================
# PROCESSING AND MAP RENDERING GENERATION PIPELINE
# =========================================================================
...
with st.spinner("⚡ Running spatial matrix optimizations..."):
    ...
    for y in range(40, h - spacing, spacing):
        for x in range(40, w - spacing, spacing):
            ...
            if smooth_green[y + b_size//2, x + b_size//2] <= 100:
                # ZONE A: HIGHWAY ACCESS CORRIDOR -> Commercial Core (Purple Hatch Blocks)
                if dist_to_transit < commercial_threshold:
                    ...
                    comm_count += 1
                # ZONE B: OPEN PLOTS VALLEYS -> Residential Sectors (Slate Blue Matrix)
                else:
    ...
    cv2.putText(blueprint, "TUMKUR REGIONAL REGION", (w - tb_w + 10, h - tb_h + 22), 
...
# =========================================================================
# REAL-TIME DATA MONITORS SECTION
# =========================================================================
